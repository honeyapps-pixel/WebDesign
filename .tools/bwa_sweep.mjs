...
const seiten = ['index','balkon-terrasse-flachdach','sockelabdichtung','lichtschacht-kellerfenster-rohrdurchfuehrung','rissinjektion','kelleraussenabdichtung','innenabdichtung-horizontalsperre','bodenplatte-wand-sohle-fuge','kontakt','impressum','datenschutz'];
const breiten = [320,360,390,480,640,700,701,760,834,900,1000,1001,1100,1101,1280,1440,1920];
let probleme = 0;
for (const s of seiten) {
  ...
  for (const w of breiten) {
    ...
    await page.goto('http://localhost:8793/' + s + '.html', { waitUntil: 'load' });
