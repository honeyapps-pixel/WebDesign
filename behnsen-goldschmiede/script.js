/* Goldschmiedewerkstatt Behnsen — Interaktion
   Bewusst schlank: Scroll-Reveal, Header-Zustand, dezente Hero-Parallaxe, Mobil-Menü. */
(function () {
  'use strict';
  ...
  function frame() {
    ...
    if (parallax && window.innerWidth > 980) {
      parallax.style.transform = 'translateY(' + (y * 0.05) + 'px)';
    }
    onScrollHeader();
    ticking = false;
  }
